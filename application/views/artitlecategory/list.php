...
<script type="text/javascript" src="statics/script/apps/artitlecategory/list.js"></script>
...
<form id="saveFormId" method="post" action="artitlecategory/create" class="well form-search"  target="formframe">
